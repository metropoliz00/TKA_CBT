                ...
                <div className="bg-white w-full max-w-5xl rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row z-10 fade-in border border-white/50">
                    ...
                    <div className="md:w-1/2 p-10 md:p-14 flex flex-col justify-center bg-white/80 backdrop-blur">
                        <div className="mb-10">
                            ...
                            <p className="text-slate-500 mt-2">Masukan identitas pengguna untuk memulai sesi.</p>
                        </div>
                        <form onSubmit={handleLogin} className="space-y-6">
                            <div>
                                <label className="block text-slate-700 text-xs font-bold mb-2 uppercase tracking-wide">Username</label>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-blue-600 transition-colors"><UserIcon size={20}/></div>
                            ...
                            <div>
                                ...
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-400 group-focus-within:text-blue-600 transition-colors"><Key size={20}/></div>
                                    <input 
                            ...
                            <button disabled={loading} className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 rounded-xl shadow-lg hover:shadow-blue-500/30 transform hover:-translate-y-0.5 transition-all duration-200 flex justify-center items-center mt-4 gap-2">
                                {loading ? (
                                    <>
                                    ...
                                    {examList.length > 0 ? (
                                        ...
                                        <div className="p-2.5 bg-red-50 border border-red-200 text-red-500 rounded-lg text-sm font-bold flex items-center gap-2">
                                            ...
                                            {currentUser?.active_exam && currentUser.active_exam !== '-' 
                                                ...
                                                : "Belum ada ujian yang diaktifkan untuk User ini."}
                                        </div>
                                    )}
                                </div>
                            </div>
